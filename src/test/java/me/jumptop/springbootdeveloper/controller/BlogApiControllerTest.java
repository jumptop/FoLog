...
@SpringBootTest // 테스트용 애플리케이션 테스트
...
class BlogApiControllerTest {
    ...
    @DisplayName("addArticale : 블로그 글 추가에 성공한다.")
    @Test
    ...
    @DisplayName("findIdArticle : 블로그 글 조회에 성공한다.")
    @Test
    ...
    public void updateArticle() throws Exception {
        ...
        // when
        ResultActions result = mockMvc.perform(put(url, savedArticle.getId()).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(request)));
